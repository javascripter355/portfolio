...
export function FreelanceSection() {
  return (
    <section
      ...
      className="relative h-full overflow-x-hidden overflow-y-auto lg:overflow-hidden border border-white/10 bg-black/10"
    >
      ...
      <div className="relative z-10 grid min-h-full grid-cols-1 lg:h-full lg:min-h-0 lg:grid-cols-[minmax(0,1.08fr)_minmax(320px,0.92fr)]">
        <div className="flex min-h-0 flex-col border-b border-white/10 p-6 pb-8 sm:p-10 lg:border-b-0 lg:border-r lg:border-white/10">
          ...
          <div className="section-enter-5 mt-8 hidden lg:grid gap-1">
        ...
        <div className="section-enter-5 flex min-h-0 flex-col justify-between p-6 pb-8 sm:p-10">
          <div>
            <p className="section-eyebrow term-label">Contact</p>
            <h3 className="mt-5 max-w-none sm:max-w-[12ch] text-[clamp(2rem,3.8vw,3.8rem)] font-black leading-[0.94] tracking-[-0.045em] text-white">
            ...
            <div className="mt-3 sm:mt-8 grid gap-3 sm:gap-4">
              <a
                ...
                className="group relative block border-t border-white/10 py-2 sm:py-4 pr-20 transition-colors duration-300 hover:border-sky-300/30"
              >
                <p className="font-mono text-[10px] uppercase tracking-[0.22em] text-sky-300/45">01  Email</p>
                <p className="mt-2 text-lg font-semibold tracking-tight text-white sm:text-3xl">laurentiuslionel@gmail.com</p>
              ...
              >
                ...
                <p className="mt-2 text-lg font-semibold tracking-tight text-white sm:text-3xl">@laurentius.lionel</p>
                <div className="pointer-events-none absolute bottom-4 right-0 flex items-center gap-3 text-sky-200/80 opacity-0 transition-all duration-300 group-hover:opacity-100">
                  <span className="h-px w-0 bg-sky-300/70 transition-all duration-300 group-hover:w-16" />
                  <span className="translate-x-[-0.35rem] font-mono text-[11px] uppercase tracking-[0.2em] transition-transform duration-300 group-hover:translate-x-0">
                    -&gt;
              ...
              >
                ...
                <p className="mt-2 text-lg font-semibold tracking-tight text-white sm:text-3xl">fiverr.com/laurentlionel</p>
                <div className="pointer-events-none absolute bottom-4 right-0 flex items-center gap-3 text-sky-200/80 opacity-0 transition-all duration-300 group-hover:opacity-100">
                  <span className="h-px w-0 bg-sky-300/70 transition-all duration-300 group-hover:w-16" />
                  <span className="translate-x-[-0.35rem] font-mono text-[11px] uppercase tracking-[0.2em] transition-transform duration-300 group-hover:translate-x-0">
                    -&gt;
