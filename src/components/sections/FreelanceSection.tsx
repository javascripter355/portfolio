      ...
      <div className="relative z-10 grid min-h-full grid-cols-1 lg:h-full lg:min-h-0 lg:grid-cols-[minmax(0,1.08fr)_minmax(320px,0.92fr)]">
        <div className="flex min-h-0 flex-col border-b border-white/10 p-6 pb-8 sm:p-10 lg:border-b-0 lg:border-r lg:border-white/10">
          <div className="shrink-0">
            ...
            <p className="section-enter-3 mt-8 max-w-2xl text-[clamp(1.1rem,1.9vw,1.75rem)] leading-[1.24] text-neutral-200">
              <span className="mark-blue">Minimal</span> surface, <span className="mark-blue">sharp</span> rhythm.
            </p>
            <p className="section-enter-4 mt-5 max-w-xl text-base leading-7 text-neutral-300 sm:text-lg sm:leading-8">
